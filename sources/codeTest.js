...
var TABLE_EXPORT = {
  EXCEL: {
    sLibelle: "Export to Excel...",
    sTitre: "Export the content to Excel...",
  },
  WORD: {
    sLibelle: "Export to Word...",
    sTitre: "Export the content to Word...",
  },
...
var HTML_TOOLBAR = {
  DLG: {
    ...
    CPY:
      "A copy of the image will be integrated into the text to apply this action",
    ERR:
...
var WDSTD_CONST = {
  ...
  PAYS: {
    ...
    GAMBIE: "Gambia",
    GEORGIE: "Georgia",
    GEORGIE_DU_SUD_ET_LES_ILES_SANDWICH_DU_SU:
    ...
    ILES_MINEURES_ELOIGNEES_DES_ETATS_UNIS:
    ...
    SAINTE_HELENE_ASCENSION_ET_TRISTAN_DA_CUN:
    ...
    TERRITOIRE_BRITANNIQUE_DE_L_OCEAN_INDIEN:
      "Indian (British Ocean Territory)",
    THAILANDE: "Thailand",
